...
Since MDSMP is based on UDP, it operates without establishing a formal connection between clients and the server. This results in a lightweight and efficient communication model, reducing overhead and latency. 

The port used for all multicast messages is 9378.

Multicast addresses groups are defined as follows:
- cpu : 230.0.0.1
- ram : 230.0.0.2
- dsk : 230.0.0.3

All messages exchanged within the MDSMP protocol must be encoded in UTF-8. This standardized encoding scheme ensures compatibility across diverse systems and prevents data corruption during transmission.
